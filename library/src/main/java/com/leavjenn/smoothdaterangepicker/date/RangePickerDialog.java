 ...
 */
public class RangePickerDialog extends DialogFragment implements OnClickListener,
    ...
    private static final String TAG = "RangePickerDialog";
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(RangePickerDialog view, int year, int monthOfYear, int dayOfMonth,
     ...
     */
    public static RangePickerDialog newInstance(OnDateSetListener callBack, int year,
                                                int monthOfYear,
                                                int dayOfMonth) {
        RangePickerDialog ret = new RangePickerDialog();
     ...
     */
    public static RangePickerDialog newInstance(OnDateSetListener callBack) {
        RangePickerDialog ret = new RangePickerDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        okButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                tryVibrate();
                if (mCallBack != null) {
                    mCallBack.onDateSet(RangePickerDialog.this,
